...
class DBSH:
    def __init__(self, db):
        ...
        self.db = dict(db.data)
        self.connecteddb = db
        self.dbname = db.dbname
        db.connected = True
        self.command_hive_helptext = f"""{Fore.GREEN}Hive{Style.RESET_ALL}{Fore.LIGHTBLACK_EX}:{Style.RESET_ALL} {Fore.BLUE}Usage{Style.RESET_ALL}{Fore.LIGHTBLACK_EX}:{Style.RESET_ALL}
    ...
    def __command_print(self, args):
        ...
        del out
        del sc
    def __command_getfile(self, args):
        try:
